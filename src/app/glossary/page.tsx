...
const glossaryData: GlossaryCategory[] = [
  {
    ...
    terms: [
      ...
      },
      {
        ...
        relatedArticle: {
          slug: "referral-hiring",
          title: "リファラル採用とは？社員紹介の仕組みと注意点",
        },
      },
      {
        term: "アルムナイ採用とは",
      ...
      },
      {
        ...
        relatedArticle: {
          slug: "skill-based-hiring",
          title: "スキルベース採用とは？学歴より実力で評価される時代",
        },
      },
      {
        term: "AI面接とは",
