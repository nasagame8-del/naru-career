    ...
    <>
      ...
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="prose">
          ...
          <p>
            24歳で新卒入社した飲食業界の会社を1年で退職し、第二新卒としてIT/Web業界にキャリアチェンジしました。現在はAIO（AI Optimization）対策を手がける企業に営業職として勤務しています。人材紹介・人材派遣会社を主要クライアントとする、SEO/AIO領域の法人営業を担当しています。テレアポから商談、契約後のコンサルティングまでを一気通貫で行っており、業務の傍らでSEO/AIOの実務知識を独学しています。
          </p>
          <p>
            そこで得た知見と僕自身の転職体験を合わせて、第二新卒の転職に役立つ情報を発信しています。
          </p>
        ...
        <div className="prose">
          <h2>このメディアについて</h2>
          <p>
            「NARU」は、僕自身の転職活動で感じた「リアルな情報が少ない」という課題から生まれた、第二新卒のIT転職ガイドです。サイト名の「NARU」と著者名の「磯貝アルト」は別の固有名詞です。
          </p>
          <p>
            転職エージェントの比較記事や業界解説は、すべて僕の実体験をベースにしています。AIに体験談を捏造させることはせず、実際に経験したことだけを発信しています。
          </p>
          <h2>経歴</h2>
          <ul>
