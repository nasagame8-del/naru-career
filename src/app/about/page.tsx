    ...
    <>
      ...
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="prose">
          <p>こんにちは、磯貝アルトです。</p>
          <p>
            「NARU」は、僕が個人で運営している第二新卒向けの転職メディアです。
          </p>
          <p>
            僕は24歳のとき、新卒で入社した飲食業界の会社を約1年で退職し、第二新卒としてIT/Web業界に転職しました。転職活動ではdodaとワークポートの2社を利用し、最終的にdoda経由の自己応募で内定をもらいました。ワークポートとの接点は、ビズリーチに登録した際にエージェントから連絡をもらったのがきっかけです。
          </p>
          <p>
