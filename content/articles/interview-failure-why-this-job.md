...
要するに、「なぜ営業か」ではなく「なぜIT業界か」しか考えていなかったのが敗因です。
...
この失敗から学んだのは、志望動機は「業界→職種→企業」の3段階で、それぞれに具体的な理由を持つ必要があるということです。
...
僕が今伝えたいのは、「なぜ」を5回深掘りする練習をしておけば、面接で詰まるリスクは大幅に下がるということです。
