...
[EXPERIENCE: 要追加ヒアリング - 面接当日の具体的なやりとり（面接官の質問とそれに対して何と答えたか、答えられなかったか）、面接前にどの程度の準備をしていたか、面接中の心理状態（焦り、頭が真っ白になったなど）について]
...
[EXPERIENCE: 要追加ヒアリング - 当時の企業選びの基準（「受かりやすそう」以外に何か考えていたか）、何社くらいに応募していた時期だったか、エージェント（ワークポート）からのアドバイスはあったかについて]
