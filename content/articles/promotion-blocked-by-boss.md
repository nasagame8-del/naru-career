...
inlineFaq:
  - heading: "何を頑張れば評価されるのかが分からなかった"
    question: "評価基準が分からないとき、まず何をすればいいですか？"
    answer: "上司に「何をどこまで達成すれば次のステップに進めますか？」と直接聞いてみてください。曖昧な回答しか返ってこない場合、それ自体が評価制度の問題を示しています。"
  - heading: "評価基準が見えない職場で起きること"
    question: "評価基準が不明確だと、具体的にどんな問題が起きますか？"
    answer: "努力の方向が定まらない、フィードバックが上司の好みの範囲になる、頑張っても報われない経験が蓄積するなど、構造的な問題が複数発生します。"
  - heading: "僕がやってみたこと、やれば良かったこと"
    question: "転職する前に、社内でやっておくべきことはありますか？"
    answer: "評価基準を文書で確認する、自分の実績を記録に残す、上司以外の人にも相談する、の3つは転職するにしても残るにしても有効です。"
---
...
基準が不明確だと、努力の方向が定まりません。結果として、「とにかく目の前の仕事を必死にやる」しかなくなります。でもそれは、地図なしで走っているのと同じです。ちなみに、近年広がりつつある[ジョブ型雇用](/articles/job-type-employment)では、職務内容と評価基準が明文化されるため、こうした「基準が見えない」問題が起きにくい構造になっています。また、[スキルベース採用](/articles/skill-based-hiring)のように「何ができるか」で評価する企業も増えてきています。
...
==評価基準が見えないのは、あなたの能力の問題ではなく、仕組みの問題==です。

もし今の職場で「何を頑張ればいいか分からない」と感じているなら、まずは基準を確認してみてください。それでも答えが返ってこないなら、それは環境を見直すサインかもしれません。いきなり転職活動を始めなくても、[カジュアル面談](/articles/casual-interview)で他社の雰囲気を知るところから始めることもできます。

同じように[評価に納得がいかない状況](/articles/unfair-evaluation-not-spoiled)を抱えている方は、あわせて読んでみてください。
